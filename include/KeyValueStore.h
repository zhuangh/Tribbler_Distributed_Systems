...
class KeyValueStoreIf {
 public:
  ...
  virtual KVStoreStatus::type Put(const std::string& key, const std::string& value) = 0;
  virtual KVStoreStatus::type AddToList(const std::string& key, const std::string& value) = 0;
  virtual KVStoreStatus::type RemoveFromList(const std::string& key, const std::string& value) = 0;
};
...
class KeyValueStoreNull : virtual public KeyValueStoreIf {
 public:
  ...
  KVStoreStatus::type Put(const std::string& /* key */, const std::string& /* value */) {
    KVStoreStatus::type _return = (KVStoreStatus::type)0;
    return _return;
  }
  KVStoreStatus::type AddToList(const std::string& /* key */, const std::string& /* value */) {
    KVStoreStatus::type _return = (KVStoreStatus::type)0;
    return _return;
  }
  KVStoreStatus::type RemoveFromList(const std::string& /* key */, const std::string& /* value */) {
    KVStoreStatus::type _return = (KVStoreStatus::type)0;
    return _return;
  }
};
...
typedef struct _KeyValueStore_Put_args__isset {
  _KeyValueStore_Put_args__isset() : key(false), value(false) {}
  bool key;
  bool value;
...
class KeyValueStore_Put_args {
 public:
  ...
  KeyValueStore_Put_args() : key(), value() {
  }
...
typedef struct _KeyValueStore_AddToList_args__isset {
  _KeyValueStore_AddToList_args__isset() : key(false), value(false) {}
  bool key;
  bool value;
...
class KeyValueStore_AddToList_args {
 public:
  ...
  KeyValueStore_AddToList_args() : key(), value() {
  }
...
typedef struct _KeyValueStore_RemoveFromList_args__isset {
  _KeyValueStore_RemoveFromList_args__isset() : key(false), value(false) {}
  bool key;
  bool value;
...
class KeyValueStore_RemoveFromList_args {
 public:
  ...
  KeyValueStore_RemoveFromList_args() : key(), value() {
  }
...
class KeyValueStoreClient : virtual public KeyValueStoreIf {
 public:
  ...
  KVStoreStatus::type AddToList(const std::string& key, const std::string& value);
  void send_AddToList(const std::string& key, const std::string& value);
  KVStoreStatus::type recv_AddToList();
  KVStoreStatus::type RemoveFromList(const std::string& key, const std::string& value);
  void send_RemoveFromList(const std::string& key, const std::string& value);
...
class KeyValueStoreMultiface : virtual public KeyValueStoreIf {
 ...
 public:
  ...
  KVStoreStatus::type AddToList(const std::string& key, const std::string& value) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->AddToList(key, value);
    }
    return ifaces_[i]->AddToList(key, value);
  }
  ...
  KVStoreStatus::type RemoveFromList(const std::string& key, const std::string& value) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->RemoveFromList(key, value);
    }
    return ifaces_[i]->RemoveFromList(key, value);
  }
