...
service KeyValueStore {
    ...
    KVStoreStatus Put(1:string key, 2:string value),
    KVStoreStatus AddToList(1:string key, 2:string value),
    KVStoreStatus RemoveFromList(1:string key, 2:string value)
}
